  ...
  return (
    <div className="rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm">
      <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h1 className="text-[clamp(1.5rem,2.4vw,2.25rem)] font-bold tracking-tight">Симулятор ЭКРОС-5400УФ</h1>
          <p className="text-[clamp(0.875rem,1.1vw,1rem)] text-zinc-600">
            Bitmap-LCD рендер 128x64 по глифовой спецификации v2.2, журнал градуировки, USB-экспорт и графики на LCD.
          </p>
        </div>
        <div className="flex flex-wrap gap-2 text-[clamp(0.75rem,0.9vw,0.875rem)] text-zinc-600">
