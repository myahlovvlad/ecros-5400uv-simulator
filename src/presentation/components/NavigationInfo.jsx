    ...
    <div className="space-y-4">
      <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm">
        ...
        <div className="space-y-2 text-sm text-zinc-700">
          ...
          <div className="rounded-2xl bg-zinc-50 p-3">LCD рисуется bitmap-шрифтом. В ручном режиме строки можно двигать по экрану мышью.</div>
        </div>
      </div>

      <MenuTreeGraph currentScreen={device.screen} />
    </div>
  );
}
